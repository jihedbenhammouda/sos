...
--
-- Client: 127.0.0.1
-- Généré le: Lun 18 Novembre 2013 à 17:23
...
--
-- Base de données: `sosanimals`
--
CREATE DATABASE IF NOT EXISTS `sosanimals` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `sosanimals`;
...
(5, 0, 'en_US', 4, 'NONE', 'Holds uncategorized reports', '009887', NULL, NULL, 1, 1);
...
(1, 'site_name', 'ushahidisos'),
(2, 'site_tagline', 'sos'),
(3, 'site_banner_id', NULL),
(4, 'site_email', 'jihed.benhammouda@esprit.tn'),
(5, 'site_key', NULL),
...
(1, '', 'Administrator', 'jihed.benhammouda@esprit.tn', 'admin', 'e98c1a28a43d6f5c80f208f35cdd6ddcaf83618f5af7a0b11f', 0, 1221420023, 0, '2013-11-18 16:16:27', 'FF0000', NULL, 1, 0, 1, 0);
